...
Asena.addCommand({pattern: 'bot', fromMe: true,dontAddCommandList: false}, (async (message, match) => {
...
Asena.addCommand({pattern: 'bot', fromMe: false,dontAddCommandList: false}, (async (message, match) => {
